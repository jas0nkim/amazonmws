"""
Django settings for rfi project.
...
SECRET_KEY = 'cl353e&i$78$h@xdip1qm)z2yjx_i_ps^g!)(r!@$@4&b^%8-p'
...
INSTALLED_APPS = [
    # rfi_* apps
    'rfi_sources.apps.RfiSourcesConfig',
...
WSGI_APPLICATION = 'rfi.wsgi.application'
