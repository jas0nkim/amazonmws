...
class EbayStore(models.Model):
    ...
    standard_shipping_fee = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    expedited_shipping_fee = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
    oneday_shipping_fee = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
