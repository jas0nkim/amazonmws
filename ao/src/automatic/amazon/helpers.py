        ...
        try:
            ...
            if ordering.order_number == None:
                return TransactionModelManager.update_transaction_amazon_order(
                    ...
                    internal_error_message=amazonmws_utils.str_to_unicode(str(ordering.error_message)))
            else:
                amazon_order = TransactionModelManager.create_amazon_order(
                    ...
                    item_price=amazonmws_utils.number_to_dcmlprice(ordering.item_price),
                    shipping_and_handling=amazonmws_utils.number_to_dcmlprice(ordering.shipping_and_handling),
                    tax=amazonmws_utils.number_to_dcmlprice(ordering.tax),
                    total=amazonmws_utils.number_to_dcmlprice(ordering.total),
