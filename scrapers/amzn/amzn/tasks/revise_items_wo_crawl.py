...
def revise_ebay_items():
    ...
    for asin in asins:
        ...
        if not amazon_item:
            ...
            continue
        handler.revise_item(ebay_item=EbayItemModelManager.fetch_one(ebay_store_id=ebay_store_id, asin=asin), 
            pictures=AmazonItemPictureModelManager.fetch(asin=asin))
