...
flock -n /applications/amazonmws/locks/reviser-e-1-p-03.lock -c '/virtualenvs/amazonmws/bin/python /applications/amazonmws/scrapers/amzn/amzn/tasks/run_reviser.py -i -e 1 -p 3 > /var/log/cron/reviser-e-1-p-03-`date +\%Y\%m\%d\%H\%M\%S`.log 2>&1'